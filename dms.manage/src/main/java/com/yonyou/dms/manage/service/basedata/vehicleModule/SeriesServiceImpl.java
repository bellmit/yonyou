...
public class SeriesServiceImpl implements SeriesService{
	...
	public List<Map> querySeries2(Map<String, String> queryParam) throws ServiceBizException {
		StringBuffer sqlSb = new StringBuffer("select tb.BRAND_CODE,ts.DEALER_CODE as DEALER_CODE,ts.SERIES_CODE,ts.SERIES_NAME   from tm_series ts,tm_brand tb where 1=1 and tb.BRAND_CODE=ts.BRAND_CODE and tb.dealer_code=ts.dealer_code ");
		List<Object> params = new ArrayList<Object>();
