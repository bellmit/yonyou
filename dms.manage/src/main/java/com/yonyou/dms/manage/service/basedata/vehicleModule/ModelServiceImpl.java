...
//		model.setInteger("oem_tag", DictCodeConstants.STATUS_IS_NOT);
	...
	public List<Map> queryModel2(Map<String, String> queryParam) throws ServiceBizException {
		StringBuilder sqlSb = new StringBuilder("select tmm.DEALER_CODE as DEALER_CODE,tmc.SERIES_CODE,tmm.MODEL_CODE,tmm.MODEL_NAME   from tm_MODEL tmm,tm_series tmc where 1=1 and tmm.SERIES_CODE=tmc.SERIES_CODE and tmm.DEALER_CODE=tmc.DEALER_CODE");
		List<Object> params = new ArrayList<Object>();
