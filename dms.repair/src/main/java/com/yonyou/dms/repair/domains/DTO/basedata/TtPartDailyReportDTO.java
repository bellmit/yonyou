 ...
 * @date 2017年4月24日
 */
public class TtPartDailyReportDTO {
    ...
    public String toString() {
        return "TtPartDailyReportDTO [dealerCode=" + dealerCode + ", reportDate=" + reportDate + ", storageCode="
               + storageCode + ", openQuantity=" + openQuantity + ", openAmount=" + openAmount + ", closeQuantity="
               + closeQuantity + ", closeAmount=" + closeAmount + ", inQuantity=" + inQuantity + ", stockInAmount="
               + stockInAmount + ", buyInCount=" + buyInCount + ", buyInAmount=" + buyInAmount + ", allocateInCount="
               + allocateInCount + ", allocateInAmount=" + allocateInAmount + ", transferInCount=" + transferInCount
               ...
               + lossOutAmount + ", upholsterOutCount=" + upholsterOutCount + ", upholsterOutCostAmount="
