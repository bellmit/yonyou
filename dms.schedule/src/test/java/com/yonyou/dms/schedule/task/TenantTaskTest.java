...
import com.yonyou.dms.schedule.task.common.FileCleanSingleTransctionTask;
import com.yonyou.dms.schedule.task.common.FileCleanTask;
...
public class TenantTaskTest extends BaseScheduleTest{
    ...
    //定时任务清理
    @Autowired
    FileCleanSingleTransctionTask fileCleanSingleTask;
    
    @Test
    public void testFileClean(){
        //自行控制事务
        fileCleanSingleTask.tenantExceute(super.testTenantId);
