...
public class TtSalesOrderDTO {
	...
	private Date permutedDate;
	private String garnitureRemark;
	...
	public String getGarnitureRemark() {
		return garnitureRemark;
	}
	public void setGarnitureRemark(String garnitureRemark) {
		this.garnitureRemark = garnitureRemark;
	}
	public Integer getIsPadConfirm() {
		return isPadConfirm;
	}
	public void setIsPadConfirm(Integer isPadConfirm) {
		this.isPadConfirm = isPadConfirm;
	}
