...
public class LoginInfoDto {
    ...
    private Integer                          haveBigCustomer;//用户是否有大客户权限

    
    private String                           mappingAccount;//经销商映射账号
    ...
    /**
     * @return the haveBigCustomer
     */
    public Integer getHaveBigCustomer() {
        return haveBigCustomer;
    }

    
    /**
     * @param haveBigCustomer the haveBigCustomer to set
     */
    public void setHaveBigCustomer(Integer haveBigCustomer) {
        this.haveBigCustomer = haveBigCustomer;
    }
