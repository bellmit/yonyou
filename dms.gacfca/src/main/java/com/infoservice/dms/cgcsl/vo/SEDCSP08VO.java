...
public class SEDCSP08VO extends BaseVO{
	...
	private LinkedList<SEDCSP08NoteInfoVO> tbVbeln;//运单号		
	...
	private LinkedList<SEDCSP08DetailInfoVO> detailInfo;//运单号		
	...
	public LinkedList<SEDCSP08NoteInfoVO> getTbVbeln() {
		return tbVbeln;
	}

	public void setTbVbeln(LinkedList<SEDCSP08NoteInfoVO> tbVbeln) {
	...
	public LinkedList<SEDCSP08DetailInfoVO> getDetailInfo() {
		return detailInfo;
	}

	public void setDetailInfo(LinkedList<SEDCSP08DetailInfoVO> detailInfo) {
