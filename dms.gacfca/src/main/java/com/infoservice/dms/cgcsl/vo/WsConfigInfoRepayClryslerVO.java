...
public class WsConfigInfoRepayClryslerVO extends BaseVO {
	...
	private String fileCustomerCardId;// 团体客户身份证明
	private String fileCustomerCardUrl;// 团体客户身份证明
	private String fileSaleContractId;// 社保缴纳凭证(实销车辆的)1
	private String fileSaleContractUrl;// 社保缴纳凭证(实销车辆的)1
	/** add weixia by 2015-4-1 **/
	...
	private String fileUrlEmpH4;  //公务员专用销售合同原件扫描件url4	public String getFileUrlEmpH3Id() {
