...
public class SalesOrderVO extends BaseVO{
	...
	private String soNo;	//合同编号
	private Date invoiceDate;//开票日期
	private String invoiceNo;//发票编号
	private String insurationName;//保险公司
	private Date insuranceBuyDate;//保险日期
	private Date salesDate;	//车辆交付日期
	private Double salesMileage;//交付时公里数
	private Integer payMode;//付款方式
	private Integer vehicleType;// 车辆用途
	private String soldBy;//店员
	private Date wrtBeginDate;//保修开始日期
	...
	private Integer district;		//所在县
	private String remark;			//备注
	private Double vehiclePrice;	//实销价格（裸车）
	
	private LinkedList<LinkManListVO> linkManList; //联系人详细VO  
	
	private Integer loanOrg;//付款银行 字典
	private Double installmentAmount;//分期金额
	private Integer installmentNumber;//分期期数 字典

	private String soldById;		//销售顾问ID
	private String soldMobile;	//销售顾问电话
	...
	private String ownerNo;//下端客户id
	
	private Double firstPermentRatio;//首付比例
	private Double loanRate;//贴息利率
	private Integer isDccOffer;//是否DCC邀约
	private Date recordDate;//开票登记日期
	
	//2015-10-15  by wangJian
	private String oldCustomerVin;//老车主VIN
	 ...
	 * @return
	 */
	private String ecOrderNo;//官网订单号	(必传)
	private String entityCode;//经销商代码（DMS端经销商代码）	(必传)
...
//	private Date saleDate;//实销日期(之前VO已上报 对应：submitTime)
	private Integer orderStatus;//订单类型	(必传)
								 ...
								 *	13011035：已完成
								 */
	private Integer escComfirmType;//官网订单类型(16001001：现车;16001002：CALL车)	(必传)
	...
	public LinkedList<SecondCarListVo> getSecondCarList() {
		return secondCarList;
	}
	public void setSecondCarList(LinkedList<SecondCarListVo> secondCarList) {
	...
	public LinkedList<LinkManListVO> getLinkManList() {
		return linkManList;
	}
	public void setLinkManList(LinkedList<LinkManListVO> linkManList) {
