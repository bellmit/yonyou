...
@Service
public class SEDCSP12CloudImpl extends BaseCloudImpl implements SEDCSP12Cloud {
	private static final Logger logger = LoggerFactory.getLogger(SEDCSP12CloudImpl.class);
