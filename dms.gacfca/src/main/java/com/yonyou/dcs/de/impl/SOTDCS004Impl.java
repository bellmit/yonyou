...
import com.yonyou.dcs.de.SOTDCS004;
 ...
 */
@Service
public class SOTDCS004Impl extends BaseImpl implements DEAction,SOTDCS004{
    
	@Autowired SOTDCS004Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SOTDCS004Impl.class);
