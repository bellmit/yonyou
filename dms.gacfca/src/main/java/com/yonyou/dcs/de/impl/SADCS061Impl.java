...
import com.yonyou.dcs.de.SADCS061;
 ...
 */
@Service
public class SADCS061Impl extends BaseImpl implements SADCS061{
    
	@Autowired
	SADCS061Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SADCS061Impl.class);
