...
import com.yonyou.dcs.de.SOTDCS005;
 ...
 */
@Service
public class SOTDCS005Impl extends BaseImpl implements DEAction,SOTDCS005{
	
	@Autowired SOTDCS005Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SOTDCS005Impl.class);
