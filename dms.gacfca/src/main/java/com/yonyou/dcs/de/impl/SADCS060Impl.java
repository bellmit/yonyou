...
import com.yonyou.dcs.de.SADCS060;
 ...
 */
@Service
public class SADCS060Impl extends BaseImpl implements SADCS060{
	
	@Autowired
	SADCS060Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SADCS060Impl.class);
