...
import com.yonyou.dcs.de.SADCS058;
 ...
 */
@Service
public class SADCS058Impl extends BaseImpl implements SADCS058{
	
	@Autowired
	SADCS058Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SADCS058Impl.class);
