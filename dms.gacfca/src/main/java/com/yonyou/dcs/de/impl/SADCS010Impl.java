...
import com.yonyou.dcs.de.SADCS010;
 ...
 */
@Service
public class SADCS010Impl extends BaseImpl implements DEAction,SADCS010{
	
	@Autowired SADCS010Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SADCS010Impl.class);
