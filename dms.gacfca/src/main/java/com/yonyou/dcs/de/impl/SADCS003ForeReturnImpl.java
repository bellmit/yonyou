...
import com.yonyou.dcs.de.SADCS003ForeReturn;
 ...
 */
@Service
public class SADCS003ForeReturnImpl extends BaseImpl implements DEAction,SADCS003ForeReturn{
    
	private static final Logger logger = LoggerFactory.getLogger(SADCS003ForeReturnImpl.class);
