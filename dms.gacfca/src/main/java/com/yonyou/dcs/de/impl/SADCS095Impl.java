...
import com.yonyou.dcs.de.SADCS095;
 ...
 */
@Service
public class SADCS095Impl extends BaseImpl implements SADCS095{
    
	@Autowired
	SADCS095Cloud Cloud;
	
	private static final Logger logger = LoggerFactory.getLogger(SADCS095Impl.class);
