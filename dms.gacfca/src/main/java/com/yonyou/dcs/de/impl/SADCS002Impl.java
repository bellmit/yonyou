...
import com.yonyou.dcs.de.SADCS002;
 ...
 */
@Service
public class SADCS002Impl extends BaseImpl implements DEAction,SADCS002{
	
	@Autowired SADCS002Cloud SADCS002Cloud;
    
	private static final Logger logger = LoggerFactory.getLogger(SADCS002Impl.class);
