 ...
 */
@Service
public class SADCS051 extends BaseImpl implements DEAction {

	@Autowired SADCS051Cloud Cloud;
    
	private static final Logger logger = LoggerFactory.getLogger(SADCS051.class);
	@Override
	public DEMessage execute(DEMessage deMsg) throws DEException {
		logger.info("========经营月报数据上报接收开始(SADCS051)========");
		try {
			...
			logger.info("========经营月报数据上报接收异常(SADCS051)========");
			t.printStackTrace();
		}finally {
		}
		logger.info("========经营月报数据上报接收结束(SADCS051)========");
		return null;
	}
