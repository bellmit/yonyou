...
import com.yonyou.dcs.de.SendDmsMsgToBold;
 ...
 */
@Service
public class SendDmsMsgToBoldImpl extends BaseImpl implements DEAction,SendDmsMsgToBold{
    
	@Autowired SendDmsMsgToBoldCloud Cloud;
    
	private static final Logger logger = LoggerFactory.getLogger(SendDmsMsgToBoldImpl.class);
