...
public class SEDCSP01DTO extends BaseVO{
	...
	private LinkedList<sedcsP01PartInfoDTO> partBaseInfoList;//配件信息
	...
	public LinkedList<sedcsP01PartInfoDTO> getPartBaseInfoList() {
		return partBaseInfoList;
	}

	public void setPartBaseInfoList(LinkedList<sedcsP01PartInfoDTO> partBaseInfoList) {
