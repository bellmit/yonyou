...
public class RecallServiceDTO extends BaseVO  {
	...
	private LinkedList<RecallServiceLabourDTO> labourListDto;//工时信息
	private LinkedList<RecallServicePartDTO> partListDto;//配件信息
	private LinkedList<RecallServiceVehicleDTO> vehicleListDto;//车辆信息
	...
	public LinkedList<RecallServiceLabourDTO> getLabourListDto() {
		return labourListDto;
	}
	public void setLabourListDto(LinkedList<RecallServiceLabourDTO> labourListDto) {
		this.labourListDto = labourListDto;
	}
	public LinkedList<RecallServicePartDTO> getPartListDto() {
		return partListDto;
	}
	public void setPartListDto(LinkedList<RecallServicePartDTO> partListDto) {
		this.partListDto = partListDto;
	}
	public LinkedList<RecallServiceVehicleDTO> getVehicleListDto() {
		return vehicleListDto;
	}
	public void setVehicleListDto(LinkedList<RecallServiceVehicleDTO> vehicleListDto) {
