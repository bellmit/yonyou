...
public class TiDmsUCustomerInfoDto {
	...
	private Integer buyCarcondition;
	private Date updateDate;
	private String giveUpType;
	private String giveUpCause;
	private String contendCar;
	private Date giveUpDate;
	private Integer isToShop;//脢脟路帽碌陆碌锚  2016-6-17 脟卤驴脥赂脛脭矛
	private Date timeToShop;//碌陆碌锚脢卤录盲
