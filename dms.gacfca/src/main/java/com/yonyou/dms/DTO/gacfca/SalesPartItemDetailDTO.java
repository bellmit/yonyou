...
public class SalesPartItemDetailDTO {
	...
	public String getOldSalesPartNo() {
		return oldSalesPartNo;
	}
	...
	public void setOldSalesPartNo(String oldSalesPartNo) {
		this.oldSalesPartNo = oldSalesPartNo;
	}
