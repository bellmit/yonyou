...
public class SEDCSP03DTO {
	...
	private LinkedList<SEDCSP03VOPartInfoDTO>	tbInputPosition;//明细信息
	...
	public LinkedList<SEDCSP03VOPartInfoDTO> getTbInputPosition() {
		return tbInputPosition;
	}
	public void setTbInputPosition(LinkedList<SEDCSP03VOPartInfoDTO> tbInputPosition) {
