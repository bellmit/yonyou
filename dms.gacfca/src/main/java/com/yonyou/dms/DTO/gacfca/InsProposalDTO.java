...
public class InsProposalDTO {
	...
	private LinkedList<InsProposalListDTO> insProposalList;
	
	private LinkedList<InsProposalCardListDTO> insProposalCardList;
	
	public LinkedList<InsProposalCardListDTO> getInsProposalCardList() {
		return insProposalCardList;
	}

	public void setInsProposalCardList(
			LinkedList<InsProposalCardListDTO> insProposalCardList) {
	...
	public LinkedList<InsProposalListDTO> getInsProposalList() {
		return insProposalList;
	}

	public void setInsProposalList(LinkedList<InsProposalListDTO> insProposalList) {
