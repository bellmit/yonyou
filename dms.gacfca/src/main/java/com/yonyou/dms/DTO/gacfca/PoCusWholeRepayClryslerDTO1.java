...
public class PoCusWholeRepayClryslerDTO1 {
	// 批售审批单主VO
	private String wsNo;// 报备单号 CHAR(13)
	...
	private Date activityDate; // 激活日期
	private String wsAuditingRemark;// 审核备注 VARCHAR(255)
	private String headApprovalFileUrl; // 总部审批附件

	private String entityCode;// 经销商代码 CHAR(8)
	...
	private Integer wsEmployeeType;// 企业员工分类 15961001 一般企业员工 15961002
									// 战略企业及其下属子公司分公司员工
	// 15961003 平安集团员工 15961004 公务员

	// add by huyu 2015-7-10
	private String companyName;

	private Integer wsthreeType;// 客户细分类别 add by huyu 2015-7-28

	private LinkedList<WsConfigInfoRepayClryslerDto> configList;// 批售配置VO
	...
	public LinkedList<WsConfigInfoRepayClryslerDto> getConfigList() {
		return configList;
	}

	public void setConfigList(LinkedList<WsConfigInfoRepayClryslerDto> configList) {
