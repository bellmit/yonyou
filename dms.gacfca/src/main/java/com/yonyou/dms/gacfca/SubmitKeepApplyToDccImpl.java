 ...
 */
@Service
public class SubmitKeepApplyToDccImpl implements SubmitKeepApplyToDcc {

	private static final Logger logger = LoggerFactory.getLogger(SubmitKeepApplyToDccImpl.class);
