...
@Service
public class SADMS001CoudImpl implements SADMS001Coud {

    private static final Logger logger = LoggerFactory.getLogger(SADMS001CoudImpl.class);

    /**
     * @author yangjie
     * @date 2017年1月17日
     * @return (non-Javadoc)
     * @see com.yonyou.dms.gacfca.SADMS001Coud#performExecute()
     */
