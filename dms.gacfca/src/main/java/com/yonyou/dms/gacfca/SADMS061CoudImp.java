...
*/
@Service
public class SADMS061CoudImp implements SADMS061Coud {
    private static final Logger logger = LoggerFactory.getLogger(SADMS061CoudImp.class);
    ...
    * (non-Javadoc)
    * @see com.yonyou.dms.gacfca.SADMS061Coud#getSADMS061()
    */
