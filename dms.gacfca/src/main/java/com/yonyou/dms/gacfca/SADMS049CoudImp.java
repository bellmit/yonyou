...
*/
@Service
public class SADMS049CoudImp implements SADMS049Coud {
	
	@Autowired DMSTODCS049Cloud DMSTODCS049Cloud;
    
    private static final Logger logger = LoggerFactory.getLogger(SADMS049CoudImp.class);
    ...
    * (non-Javadoc)
    * @see com.yonyou.dms.gacfca.SADMS049Coud#getSADMS061(com.yonyou.dms.common.domains.DTO.basedata.PotentialCusDTO, java.lang.String)
    */
