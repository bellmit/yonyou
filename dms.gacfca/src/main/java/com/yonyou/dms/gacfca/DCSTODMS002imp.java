...
*/
@Service
public class DCSTODMS002imp implements DCSTODMS002 {
    
    private static final Logger logger = LoggerFactory.getLogger(DCSTODMS002imp.class);
    @Autowired
    ...
    * (non-Javadoc)
    * @see com.yonyou.dms.gacfca.DCSTODMS002#getSADMS061(java.util.LinkedList, java.lang.String)
    */
