...
*/
@Service
public class SEDMS061Impl implements SEDMS061 {
    private static final Logger logger = LoggerFactory.getLogger(SEDMS061Impl.class);
    ...
    * (non-Javadoc)
    * @see com.yonyou.dms.gacfca.SEDMS061#getSEDMS061(java.lang.String)
    */
