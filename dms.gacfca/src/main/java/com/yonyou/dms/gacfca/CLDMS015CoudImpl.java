...
import com.yonyou.dms.gacfca.CLDMS015Coud;
 ...
 */
@Service
public class CLDMS015CoudImpl implements CLDMS015Coud{

	final Logger logger = Logger.getLogger(CLDMS015CoudImpl.class);
