...
*/
@Service
public class SEDMS058CoudImpl implements SEDMS058Coud {
    
    private static final Logger logger = LoggerFactory.getLogger(SEDMS058CoudImpl.class);
    @Autowired
    ...
    * @throws Exception
    * (non-Javadoc)
    * @see com.yonyou.dms.gacfca.SEDMS058Coud#getSEDMS058(java.lang.String, java.lang.String)
    */
