...
@Service
public class EAI2DCSServletImpl extends BaseService implements EAI2DCSServlet {
	private static Logger logger = LoggerFactory.getLogger(EAI2DCSServletImpl.class);
	//第二步：覆盖doGet()方法
