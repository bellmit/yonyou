...
public class SI39Dao extends OemBaseDAO {
	...
	public static List<SI39DTO> getSI39Info() {
		...
		sql.append("    INNER JOIN TT_VS_MONTHLY_FORECAST_DETAIL_COLOR TVMFDC ON POS.DETAIL_COLOR_ID = TVMFDC.DETAIL_COLOR_ID  \n");
		sql.append("    INNER JOIN TT_VS_MONTHLY_FORECAST_DETAIL TVMFD ON TVMFD.DETAIL_ID = TVMFDC.DETAIL_ID  \n");
