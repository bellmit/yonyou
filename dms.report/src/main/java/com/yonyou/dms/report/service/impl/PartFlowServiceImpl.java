...
public class PartFlowServiceImpl implements PartFlowService{
    ...
    * (non-Javadoc)
    * @see com.yonyou.dms.report.service.impl.PartFlowService#queryPartflows(java.util.Map)
    */
    ...
    * @throws ServiceBizException
    * (non-Javadoc)
    * @see com.yonyou.dms.report.service.impl.PartFlowService#queryPartdetails(java.util.Map)
    */
    ...
    * @throws ServiceBizException
    * (non-Javadoc)
    * @see com.yonyou.dms.report.service.impl.PartFlowService#queryPartdetailExport(java.util.Map)
    */
    ...
    * @throws ServiceBizException
    * (non-Javadoc)
    * @see com.yonyou.dms.report.service.impl.PartFlowService#queryPartflowsById(java.lang.Long)
    */
