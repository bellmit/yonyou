...
public class DecrodateProjectDTO {
	...
	//Copy
	private String srcLabourModel;//原车型组
	private String dstLabourModel;//复制到车型组
	
	public String getSrcLabourModel() {
		return srcLabourModel;
	}
	public void setSrcLabourModel(String srcLabourModel) {
		this.srcLabourModel = srcLabourModel;
	}
	public String getDstLabourModel() {
		return dstLabourModel;
	}
	public void setDstLabourModel(String dstLabourModel) {
		this.dstLabourModel = dstLabourModel;
	}
