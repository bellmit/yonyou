...
import com.yonyou.dms.vehicle.dao.oldPart.DealerOldPartClipPrintDao;
@Service
public class DealerOldPartClipPrintServiceImpl implements DealerOldPartClipPrintService{
	@Autowired
	DealerOldPartClipPrintDao dao;
	@Override
