...
public class TtWrForeotheritemsRuleDTO {
	...
	public void setOtheritemCode(String otheritemCode){
		this.otheritemCode=otheritemCode;
	}

	public String getOtheritemCode(){
		return this.otheritemCode;
	}
