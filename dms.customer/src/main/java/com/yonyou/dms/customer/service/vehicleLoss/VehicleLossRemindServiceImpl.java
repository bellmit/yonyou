...
public class VehicleLossRemindServiceImpl implements VehicleLossRemindService{
	...
	public PageInfoDto queryVehicleLossRemind(Map<String, String> queryParam) throws ServiceBizException {
		...
		Utility.sqlToDate(sb,queryParam.get("startNotInDate"), queryParam.get("endNotInDate"), "LAST_MAINTAIN_DATE", "B");
...
//		}
		...
		Utility.sqlToDate(sb,queryParam.get("last_maintain_begin_date"), queryParam.get("last_maintain_end_date"), "LAST_MAINTAIN_DATE", "B");
		...
		Utility.sqlToDate(sb,queryParam.get("salesDateBegin"), queryParam.get("salesDateEnd"), "SALES_DATE", "B");
		Utility.sqlToDate(sb,queryParam.get("remindDateBegin"), queryParam.get("remindDateEnd"), "REMIND_DATE", "D");
